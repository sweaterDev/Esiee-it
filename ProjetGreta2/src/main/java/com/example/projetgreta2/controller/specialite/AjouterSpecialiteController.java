...
@WebServlet(name = "AjouterSpecialiteController", value = "/ajouterSpecialite")
public class AjouterSpecialiteController extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            specialiteDAO.ajouterSpecialite(idCompte, idMatiere);
        } catch (Exception e) {
            e.printStackTrace();
        }

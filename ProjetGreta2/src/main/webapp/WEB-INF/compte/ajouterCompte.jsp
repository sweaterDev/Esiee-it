...
%>
<%
    java.util.List<Compte> listeComptes = (java.util.List<Compte>) request.getAttribute("listeComptes");
    if(listeComptes != null) {
        request.setAttribute("listeComptes", listeComptes);
    }
%>
<h1>Ajouter un Nouveau compte</h1>
<form action="ajouterCompteController" method="post" class="form-example" enctype="application/x-www-form-urlencoded">

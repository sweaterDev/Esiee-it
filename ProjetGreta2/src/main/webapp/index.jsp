<%@ page import="com.example.projetgreta2.dao.MatiereDAO" %>
...
<%
    ...
    ArrayList<Matiere> matieres = matiereDAO.listerMatieres();
...
%>
<form action="formcontroller" method="post" class="form-example" enctype="application/x-www-form-urlencoded" style="display: block">
